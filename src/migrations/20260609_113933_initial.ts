...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_rate_limits_action" AS ENUM('comment', 'like');
  ...
  CREATE TABLE "rate_limits" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"ip" varchar NOT NULL,
  	"action" "enum_rate_limits_action" NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  ALTER TABLE "comment_likes" ADD CONSTRAINT "comment_likes_comment_id_comments_id_fk" FOREIGN KEY ("comment_id") REFERENCES "public"."comments"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_comment_likes_fk" FOREIGN KEY ("comment_likes_id") REFERENCES "public"."comment_likes"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "comment_likes_comment_idx" ON "comment_likes" USING btree ("comment_id");
  CREATE INDEX "comment_likes_anon_id_idx" ON "comment_likes" USING btree ("anon_id");
  CREATE INDEX "comment_likes_updated_at_idx" ON "comment_likes" USING btree ("updated_at");
  CREATE INDEX "comment_likes_created_at_idx" ON "comment_likes" USING btree ("created_at");
  CREATE UNIQUE INDEX "comment_anonId_idx" ON "comment_likes" USING btree ("comment_id","anon_id");
  ...
  CREATE INDEX "payload_locked_documents_rels_comment_likes_id_idx" ON "payload_locked_documents_rels" USING btree ("comment_likes_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_rate_limits_action";`)
}
